  ...
  module Contracts
    class PaymentContract < Dry::Validation::Contract
      params do
        ...
        optional(:description).value(Entity::Types::String, max_size?: 150)
        ...
        optional(:payment_token).value(Entity::Types::String)

        # Saved payment method's ID: https://yookassa.ru/en/developers/payments/recurring-payments
        optional(:payment_method_id).value(Entity::Types::String)
        ...
        optional(:metadata).value(Entity::Types::String)
        ...
        optional(:merchant_customer_id).value(Entity::Types::String, max_size?: 200)
      end
    end
  end
end
